  ...
  return (
    <div className="container mx-auto px-4 sm:px-6 py-4 sm:py-6">
      ...
      <motion.div
        ...
        className="p-6 sm:p-8 rounded-2xl gradient-card card-soft mb-6"
      >
            ...
            {selectedContacts.length > 0 && (
              ...
              >
                <Button
                  ...
                  className="w-full md:w-auto gap-2 bg-gradient-to-r from-primary to-primary-dark hover:from-primary-dark hover:to-primary transition-all duration-300 shadow-lg hover:shadow-xl text-sm sm:text-base"
                >
